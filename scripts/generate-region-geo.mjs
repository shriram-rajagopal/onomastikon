...
const HULLS = {
  ...
  // The medieval steppe confederations (added 2026-07-28 for the globe): each a
  // rough roaming envelope from the extent its page describes, not a border.
  huns: [[18.0, 47.5], [24.0, 49.0], [33.0, 50.0], [42.0, 50.0], [48.0, 48.5], [46.0, 45.5], [38.0, 45.0], [28.0, 45.0], [20.0, 45.5]],
  avars: [[16.5, 46.5], [20.0, 48.5], [28.0, 49.0], [36.0, 48.5], [40.0, 47.0], [35.0, 45.0], [26.0, 45.0], [18.0, 45.2]],
  sarmatians: [[30.0, 46.0], [37.0, 49.0], [45.0, 49.5], [52.0, 48.0], [54.0, 46.0], [48.0, 44.5], [40.0, 45.0], [32.0, 45.0]],
  alans: [[38.0, 46.5], [44.0, 48.0], [48.0, 47.0], [49.0, 44.5], [46.0, 42.8], [42.0, 42.8], [38.5, 44.5]],
  khazars: [[38.0, 44.0], [44.0, 48.5], [49.0, 49.0], [53.0, 47.5], [53.5, 44.5], [50.0, 42.5], [45.0, 43.0], [39.5, 42.8]],
  gokturks: [[88.0, 44.0], [96.0, 49.0], [105.0, 51.0], [115.0, 49.5], [119.0, 46.5], [112.0, 43.5], [100.0, 42.5], [90.0, 42.5]],
  hephthalites: [[59.0, 33.0], [62.0, 37.5], [67.0, 38.5], [71.0, 37.0], [72.0, 34.0], [68.0, 32.0], [63.0, 31.5], [60.0, 31.8]],
};
