...
Imperial Aramaic was originally written in the Aramaic alphabet, the ancestor of the modern Hebrew, Syriac, and Arabic scripts. The Hebrew-script form *ארמיא* used in entries here is a modern scholarly convention; ancient inscriptions used the Aramaic alphabet, which has limited font support in modern digital environments.
