...
export const ENTITY_GEO: Record<string, EntityGeo> = {
  ...
  sogdiana: { kind: 'region', label: 'Sogdiana', points: [[64.0, 40.5], [67.0, 40.4], [68.5, 39.5], [67.0, 38.5], [64.5, 39.0]] },
  iran: { kind: 'region', label: 'Iran', points: [[46.0, 39.0], [54.0, 37.2], [61.0, 36.2], [61.0, 30.0], [56.0, 27.0], [50.0, 28.0], [46.5, 32.5]] },
  gandhara: { kind: 'region', label: 'Gandhāra', points: [[71.0, 34.5], [73.0, 34.2], [73.2, 33.4], [72.0, 33.2], [71.1, 33.8]] },
  punjab: { kind: 'region', label: 'the Punjab', points: [[71.5, 32.6], [75.0, 32.0], [76.0, 30.5], [73.5, 29.6], [71.2, 31.0]] },
  sindh: { kind: 'region', label: 'Sindh', points: [[67.0, 27.5], [69.5, 27.0], [70.0, 25.0], [68.0, 24.0], [66.8, 25.6]] },
